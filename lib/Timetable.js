...
function Timetable({ items, renderItem, date, range: rangeProp, fromHour = 0, toHour = 24, style, width, timeWidth = 50, itemMinHeightInMinutes = 15, hourHeight = 60, linesTopOffset = 18, linesLeftInset = 15, columnHorizontalPadding = 10, stickyHours, renderHeader, renderHour, startProperty = 'startDate', endProperty = 'endDate', ...props }) {
